...
class PybulletSimulator:
    ...
    def run_pybullet_simulation(self):
        ...
        for self.timestep_counter in range(self.all_args.n_timesteps):
            ...
            position_3d, quaternion_4d = p.getBasePositionAndOrientation(drone_id, physicsClientId=self.client_id)

            position_3d = tuple(np.array(position_3d) + np.random.rand(3) * 0.05)

            p.resetBasePositionAndOrientation(drone_id, position_3d, quaternion_4d)
